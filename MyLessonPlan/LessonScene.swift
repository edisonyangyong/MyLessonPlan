...
class LessonScene: UIView {
    var cellHeights: [(name:String,height:CGFloat)] = [("roadMap", 250),("curve",55),("reminder", 200),("title", 120),("textView", 150),("textView", 150)]
    var roadMap:UIImageView = {
        let roadMap = UIImageView()
        roadMap.image = #imageLiteral(resourceName: "roadMap_Adaption")
    ...
    var what:UILabel = {
        let what = UILabel()
        what.text = "What is Lesson Adaptation & Reflective Questions"
