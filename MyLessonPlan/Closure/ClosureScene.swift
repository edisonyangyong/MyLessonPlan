...
class ClosureScene: UIView {
    ...
    var roadMap:UIImageView = {
        ...
        roadMap.image = #imageLiteral(resourceName: "roadMap_Closure")
    ...
    var inspirationButton:UIButton = {
        ...
        inspirationButton.layer.shadowOffset = CGSize(width: 3.0, height: 3.0)
    ...
    var _inspirationButton:UIButton?
